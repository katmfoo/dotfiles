...
# create directory/files for sublime files incase they don't already exist
...
touch ~/Library/'Application Support'/'Sublime Text 3'/Packages/Users/'Package Control.sublime-settings'
